...
def get_feats_blank(field, year, month, day, min_num, max_num):
	...
	#print(flux)
	 ...
	 # Find VariabilityIndex beacuase FATS has it removed
			...
			VariabilityIndex.append(VarIndex)
                        ...
                        #except:
                         #       print 'exception raised in FATS passed'
	...
	print feature_table
	output = '/home/swebb/oz100/LC_CLUSTERS/feature_lists/'+year+'_'+month+'_'+field+'_'+day+'/'+year+'_'+month+'_'+field+'_'+day+'_feat_'+str(max_num)+'.ascii'
	print(output)
